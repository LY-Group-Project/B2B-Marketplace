...
router.get('/admin/:id', auth, adminAuth, validateObjectId('id'), getVendorDetails);
router.patch('/admin/:id/status', auth, adminAuth, validateObjectId('id'), updateVendorStatus);
