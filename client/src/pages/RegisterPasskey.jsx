            ...
            <div className="max-w-md w-full space-y-8">
                <div className="text-center">
                    ...
                    <p className="text-gray-400">
                        Add a passkey to enable passwordless, phishing-resistant
                        login.
                    </p>
                </div>
                ...
                <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                    ...
                    <p className="text-sm text-gray-400 mb-4">
                        Use a device with a platform authenticator (Touch ID,
                        Windows Hello, Android biometrics) or an external
                        security key.
                    </p>
                    ...
                    <ul className="space-y-3 text-sm text-gray-300">
                        {passkeyFeatures.map((f, i) => (
                            <li key={i} className="flex items-start gap-3">
                                <div className="mt-1">
                                    <i
                                        className={`fas ${f.icon} text-primary-400 text-lg`}
                                    ></i>
                                </div>
                                <div>
