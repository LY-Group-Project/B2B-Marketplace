...
const AdminOrders = () => {
  ...
  const { data: ordersData, isLoading } = useQuery({
    queryKey: ['adminOrders', { search: searchTerm, status: statusFilter, sortBy, sortOrder }],
      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600">Monitor and manage all customer orders</p>
          </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900">{selectedOrder.paymentStatus || 'Pending'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm"><span className="font-medium">Phone:</span> {selectedOrder.user?.phone || 'N/A'}</p>
                  </div>
                </div>
                ...
                {selectedOrder.shippingAddress && (
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-2">Shipping Address</h4>
