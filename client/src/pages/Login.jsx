...
const Login = () => {
    ...
    const handlePasskeyAuth = async (email) => {
        try {
            ...
            passkeyMutation.mutate({ username: email, assertion: transformedAssertion });
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="p-4 bg-gray-800 border border-gray-700 rounded-lg">
                                ...
                                <div className="space-y-2 text-xs text-gray-400">
                                    <p><span className="text-gray-300">Customer:</span> customer@demo.com / password123</p>
                                    <p><span className="text-gray-300">Vendor:</span> vendor@demo.com / password123</p>
                                    <p><span className="text-gray-300">Admin:</span> admin@demo.com / password123</p>
                                </div>
                            </div>
                        </form>
                    )}
