...
const OrderDetail = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Order #{order._id.slice(-8).toUpperCase()} - B2B Marketplace</title>
      </Helmet>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className={`inline-flex items-center px-4 py-2 rounded-lg border ${statusInfo.color} mb-6`}>
                ...
                <div className="space-y-4">
                  {order.items.map((item, index) => (
                    <div key={index} className="flex items-center space-x-4 py-4 border-b border-gray-100 last:border-b-0">
                      <img
                        src={item.product?.images?.[0]?.url || item.image || 'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNjQiIGhlaWdodD0iNjQiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PHJlY3Qgd2lkdGg9IjEwMCUiIGhlaWdodD0iMTAwJSIgZmlsbD0iI2RkZCIvPjwvc3ZnPg=='}
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500">
                          Vendor: {item.product?.vendor?.name || item.vendor?.name || 'N/A'}
                        </p>
                      </div>
                      <div className="text-center">
