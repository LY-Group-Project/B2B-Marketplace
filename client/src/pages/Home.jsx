  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Discover amazing products from trusted vendors worldwide. Shop electronics, fashion, home goods, and more." />
      </Helmet>
            ...
            {featuredLoading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {featuredProducts?.map((product) => (
                  <div key={product._id} className="bg-white rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300 group">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Quick and reliable shipping from vendors worldwide to your doorstep.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Carefully curated products from verified vendors with customer reviews.
                </p>
              </div>
            </div>
          </div>
