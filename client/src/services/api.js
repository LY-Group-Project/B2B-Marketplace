...
export const searchAPI = {
  ...
  searchSuggestions: (query) => api.get(`/products?search=${encodeURIComponent(query)}&limit=5`),
};
...
export const categoriesAPI = {
  ...
  createVendorCategory: (categoryData) => api.post('/categories/vendor', categoryData),
...
export const vendorAPI = {
  ...
  updateVendorStatus: (id, data) => api.patch(`/vendors/admin/${id}/status`, data),
...
export const adminAPI = {
  ...
  updateVendorStatus: (id, data) => api.patch(`/admin/vendors/${id}/status`, data),
};
